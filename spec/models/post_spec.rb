...
RSpec.describe Post, type: :model do
  ...
  author.save
  subject { Post.new(author:, title: 'First post', text: 'Lorem Ipsum') }
  ...
  context 'When testing recent_comments method' do
    it 'should return the last five comments' do
      Comment.create(post: subject, author:, text: 'Sed auctor.')
      second_comment = Comment.create(post: subject, author:, text: 'Suspendisse at magna elit.')
      third_comment = Comment.create(post: subject, author:, text: 'Nam consectetur.')
      fourth_comment = Comment.create(post: subject, author:, text: 'Maecenas finibus.')
      fifth_comment = Comment.create(post: subject, author:, text: 'Maecenas finibus.')
      sixth_comment = Comment.create(post: subject, author:, text: 'Maecenas finibus.')
